...
PASS  __tests__/users.test.js
  Users API Tests - Оценка 3
    POST /v1/users/register
      ✓ должна успешно зарегистрировать нового пользователя (234ms)
      ✓ должна вернуть ошибку при повторной регистрации (89ms)
      ✓ должна вернуть ошибку валидации при невалидном email (45ms)
      ✓ должна вернуть ошибку валидации при коротком пароле (43ms)
    POST /v1/users/login
      ✓ должна успешно авторизовать пользователя (156ms)
      ✓ должна вернуть ошибку при неправильном пароле (123ms)
      ✓ должна вернуть ошибку при несуществующем email (98ms)
    GET /v1/users/profile - защищённый путь
      ✓ должна вернуть отказ при доступе без токена (23ms)
      ✓ должна вернуть отказ при невалидном токене (34ms)
      ✓ должна успешно вернуть профиль (67ms)
